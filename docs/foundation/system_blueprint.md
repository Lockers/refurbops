...
- FUll business tenanted system with user roles, backend authentication, bug ticketing system, chatbot ai integration if possible
- intake and booking
- barcode tracking
...
business_id or UUID (to confirm)
