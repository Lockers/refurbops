...
# Module 0 Data Model Working Notes

This file is the working alignment copy of `data_model_v1.md`.

Purpose:
- align the data model to `refurbops_module_0_spec.md`
- update tenant / auth / role / billing / BM integration foundations
- do this here first before replacing the older shared data model doc

## Module 0 areas this file must cover
- businesses
- business_profile_settings
- users
- auth_sessions
- backmarket_integration
- backmarket_sync_state
- support_tickets
- audit_log
- security_log

## Core role set to align to
- platform_owner
- manager
- business_admin
- backmarket_admin
